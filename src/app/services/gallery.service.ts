...
export class GalleryService {
  ...
  async getAllPhotos(): Promise<Photo[]> {
    return [
      {
        pictureUrl:
          'https://drive.google.com/uc?export=view&id=1jFeb04pnaxo6Us7srvfqsYoxdVDJDJ4a',
      ...
      },
      {
        ...
        pictureUrl:
          'https://drive.google.com/uc?export=view&id=1rjdVfHYbebYMGHs-zxtzN0khlro9exu4',
        title: 'Maria',
      },
      {
        title: 'Maria',
        pictureUrl:
          'https://drive.google.com/uc?export=view&id=1HRAeR_YgNzMNTR439OB6eLal1wIgjn7S',
        type: 'gallery',
      ...
      },
      {
        ...
        title: 'Maria',
        pictureUrl:
          'https://drive.google.com/uc?export=view&id=1wmWVr-KlqAjFKROtmFlUWSyvgncoCY9z',
